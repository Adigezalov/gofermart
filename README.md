...
# В другом терминале: регистрация тестовых заказов для начислений
make register-test-orders
...
**Важно:** Для тестирования начислений нужно зарегистрировать заказы в accrual системе командой `make register-test-orders`.
...
- `make register-test-orders` - **Зарегистрировать тестовые заказы** в accrual системе
